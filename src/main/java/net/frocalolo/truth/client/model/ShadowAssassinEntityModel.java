...
public class ShadowAssassinEntityModel extends EntityModel<ShadowAssassinEntity> {
    ...
    public ShadowAssassinEntityModel(ModelPart modelPart) {
    ...
    @Override
    public void setAngles(ShadowAssassinEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
