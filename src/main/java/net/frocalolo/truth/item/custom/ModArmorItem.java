package net.frocalolo.truth.item.custom;

import com.google.common.collect.ImmutableMap;
import net.frocalolo.truth.item.ModArmorMaterial;
...
public class ModArmorItem extends ArmorItem {
    private static final Map<ArmorMaterial, StatusEffect> MATERIAL_TO_EFFECT_MAP = (new ImmutableMap.Builder<ArmorMaterial, StatusEffect>()).put(ModArmorMaterial.SHADOW_ASSASSIN, StatusEffects.STRENGTH).build();
